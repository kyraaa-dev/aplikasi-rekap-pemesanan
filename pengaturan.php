            ...
            <div class="settings-grid">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="admin_password" placeholder="Masukkan password baru..." style="width: 100%; padding: 0.75rem 1rem; border: 1px solid var(--gray-light); border-radius: 6px; font-size: 0.95rem; box-sizing: border-box;">
                    </div>
