    ...
    <main class="main-content">
        ...
        <div class="panel" style="margin: 1.5rem 0; padding: 0; border-radius: 16px; background: var(--white); box-shadow: 0 4px 20px rgba(0,0,0,0.06); border: 1px solid var(--gray-light); overflow: hidden;">
            <div style="display: flex; flex-wrap: wrap;">
                ...
                <div style="flex: 1; min-width: 300px; padding: 2.5rem; background: linear-gradient(145deg, #F8FAFC 0%, #F1F5F9 100%); border-right: 1px solid var(--gray-light);">
                    <div style="display: inline-flex; align-items: center; justify-content: center; width: 48px; height: 48px; border-radius: 12px; background: #EEF2FF; color: #4F46E5; margin-bottom: 1.5rem;">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-grid">
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <select name="skpd_id" required style="background: #F8FAFC;">
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <input type="text" name="nama_pemesan" placeholder="Masukkan nama pemesan (jika ada)" style="background: #F8FAFC;">
                            </div>
                        </div>
                        ...
                        <div class="form-grid-3">
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin" required style="background: #F8FAFC;">
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <select name="jenis_mutz" required style="background: #F8FAFC;">
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <select name="ukuran" id="ukuran" required style="background: #F8FAFC;">
                        ...
                        <div class="form-grid-3">
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <input type="number" name="jumlah" value="1" min="1" required style="background: #F8FAFC;">
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <select name="status_bayar" required style="background: #F8FAFC;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="catatan" placeholder="Contoh: Titip ke bagian admin, minta dikemas terpisah, dsb." style="background: #F8FAFC;">
                        </div>
