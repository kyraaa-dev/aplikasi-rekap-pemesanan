                        ...
                        <tr class="<?= $empty_class ?>">
                            ...
                            <td class="td-skpd" rowspan="<?= $rowspan ?>">
                                <div style="display: flex; justify-content: space-between; align-items: center; gap: 8px;">
                                    ...
                                    <?php if ($skpd_total > 0): ?>
                                        <button type="button" 
                                                class="btn-wa-notify hide-on-print" 
                                                ...
                                                style="background: #25D366; color: white; border: none; border-radius: 4px; padding: 3px 6px; font-size: 0.7rem; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 3px; box-shadow: 0 1px 3px rgba(37,211,102,0.25); flex-shrink: 0;">
